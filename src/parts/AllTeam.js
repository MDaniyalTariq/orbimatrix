...
export default function AllTeam({ data }) {
  return (
    <section className="container mx-4 sm:mx-auto">
      {/* <div className="grid grid-rows-2 gap-y-8 gap-x-16 sm:gap-16 md:gap-16 lg:gap-16 xl:gap-16 justify-items-center">
                ...
                <div className="flex flex-col w-48 h-60 sm:w-56 sm:h-72 md:w-60 md:h-80 rounded-xl shadow-xl border border-light-theme-purple justify-center transform transition duration-500 hover:scale-105 dark:bg-[#1B1F2B]">
                  <div className="flex justify-center mb-5">
                    <img
                      src={item.imageUrl}
                      alt="Team Member"
                      className="w-24 h-24 rounded-full sm:w-28 sm:h-28 md:w-36 md:h-36"
                    />
                  </div>
        ...
        <div className="grid justify-center grid-cols-2 gap-16">
          {" "}
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
        <div className="items-center rounded-lg shadow bg-gray-50 sm:flex dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img
